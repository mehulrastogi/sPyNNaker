...
static inline const char *synapse_types_get_type_char(
    ...
    if (synapse_type_index == EXCITATORY) {
        ...
        log_mini_debug("%u%i", 7354, synapse_type_index);  /* "did not recognise synapse type %i"*/
        return "?";
    }
}
...
static inline void synapse_types_print_parameters(synapse_param_pointer_t parameter) {
    log_mini_debug("%u", 7355);  /* "-------------------------------------\n"*/
    log_mini_debug("%u%11.4k", 7356, parameter->exc.lin_buff * parameter->exc.exp_buff);  /* "exc_response  = %11.4k\n"*/
    log_mini_debug("%u%11.4k", 7357, parameter->inh.lin_buff * parameter->inh.exp_buff);  /* "inh_response  = %11.4k\n"*/
}
