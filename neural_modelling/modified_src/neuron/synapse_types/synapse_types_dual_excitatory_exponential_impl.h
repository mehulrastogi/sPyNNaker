...
static inline const char *synapse_types_get_type_char(
    ...
    if (synapse_type_index == EXCITATORY_ONE) {
        ...
        log_mini_debug("%u%i", 7344, synapse_type_index);  /* "did not recognise synapse type %i"*/
        return "?";
    }
}
...
static inline void synapse_types_print_parameters(
        synapse_param_pointer_t parameter) {
    log_mini_info("%u%11.4k", 7345, parameter->exc.decay);  /* "exc_decay  = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7346, parameter->exc.init);  /* "exc_init   = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7347, parameter->exc2.decay);  /* "exc2_decay = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7348, parameter->exc2.init);  /* "exc2_init  = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7349, parameter->inh.decay);  /* "inh_decay  = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7350, parameter->inh.init);  /* "inh_init   = %11.4k\n"*/
    log_mini_info("%u%11.4k", 7351,parameter->exc.synaptic_input_value);
    /* "gsyn_excitatory_initial_value = %11.4k\n"*/

    log_mini_info("%u%11.4k", 7352,parameter->exc2.synaptic_input_value);
    /* "gsyn_excitatory2_initial_value = %11.4k\n"*/

    log_mini_info("%u%11.4k", 7353,parameter->inh.synaptic_input_value);
