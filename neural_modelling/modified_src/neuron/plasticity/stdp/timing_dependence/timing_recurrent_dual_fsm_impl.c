...
uint32_t *timing_initialise(address_t address) {
    ...
    log_mini_info("%u", 7171);  /* "timing_initialise: starting"*/
    log_mini_info("%u", 7172);  /* "\tRecurrent dual-FSM STDP rule"*/
    ...
    log_mini_info("%u%d%d", 7173,plasticity_trace_region_data.accumulator_depression_plus_one - 1,plasticity_trace_region_data.accumulator_potentiation_minus_one + 1);
    ...
    log_mini_info("%u", 7174);  /* "timing_initialise: completed successfully"*/
