...
static inline int16_t timing_add_spike(uint32_t time, uint32_t last_time, int16_t last_trace)
{
    ...
    log_mini_debug("%u%d%d", 7168, delta_time, new_trace);  /* "\tdelta_time=%d, new_trace=%d\n"*/
    ...
    post_trace_t last_post_trace, update_state_t previous_state)
{
    ...
    log_mini_debug("%u%u%d", 7169,time_since_last_post, decayed_o1);
    ...
    post_trace_t last_post_trace, update_state_t previous_state)
{
    ...
    log_mini_debug("%u%u%d", 7170,time_since_last_pre, decayed_r1);
