...
address_t timing_initialise(address_t address) {
    ...
    log_mini_info("%u", 7206);  /* "timing_initialise: starting"*/
    log_mini_info("%u", 7207);  /* "\tSTDP nearest-pair rule"*/
    ...
    log_mini_info("%u", 7208);  /* "timing_initialise: completed successfully"*/
