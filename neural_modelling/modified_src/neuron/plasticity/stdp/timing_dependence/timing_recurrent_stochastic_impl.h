// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_recurrent_stochastic_impl.h
...
static inline bool _in_window(
    ...
    if (time_since_last_event < cdf_lut_size) {
        ...
        log_mini_debug("%u%d%d", 7220, cdf, random);  /* "\t\tCDF=%d, Random=%d"*/
