...
static inline post_trace_t timing_add_post_spike(
    ...
    log_mini_debug("%u%d%d", 7212, delta_time, new_o1_trace);  /* "\tdelta_time=%d, o1=%d\n"*/
...
static inline pre_trace_t timing_add_pre_spike(
    ...
    log_mini_debug("%u%u%d", 7213, delta_time, new_r1_trace);  /* "\tdelta_time=%u, r1=%d\n"*/
...
static inline update_state_t timing_apply_pre_spike(
    ...
    if (time_since_last_post > 0) {
        ...
        log_mini_debug("%u%u%d", 7214,time_since_last_post, decayed_o1);
...
static inline update_state_t timing_apply_post_spike(
    ...
    if (time_since_last_pre > 0) {
        ...
        log_mini_debug("%u%u%d", 7215,time_since_last_pre, decayed_r1);
