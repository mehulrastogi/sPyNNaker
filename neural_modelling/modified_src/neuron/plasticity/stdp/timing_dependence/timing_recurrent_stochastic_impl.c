// DO NOT EDIT! THIS FILE WAS GENERATED FROM src/neuron/plasticity/stdp/timing_dependence/timing_recurrent_stochastic_impl.c
...
address_t timing_initialise(address_t address) {
    ...
    log_mini_info("%u", 7149);  /* "timing_initialise: starting"*/
    log_mini_info("%u", 7150);  /* "\tRecurrent stochastic STDP rule"*/
    ...
    log_mini_info("%u%d%d", 7151,plasticity_trace_region_data.accumulator_depression_plus_one - 1,plasticity_trace_region_data.accumulator_potentiation_minus_one + 1);
    ...
    log_mini_info("%u", 7152);  /* "timing_initialise: completed successfully"*/
