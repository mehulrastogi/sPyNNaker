...
static inline weight_t weight_get_final(weight_state_t new_state) {
    ...
    log_mini_debug("%u%u%d%d%d%d%d", 7238,new_state.initial_weight, new_state.a2_plus, new_state.a2_minus,scaled_a2_plus, scaled_a2_minus, new_weight);
    /* "\told_weight:%u, a2+:%d, a2-:%d, scaled a2+:%d, scaled a2-:%d, new_weight:%d"*/
