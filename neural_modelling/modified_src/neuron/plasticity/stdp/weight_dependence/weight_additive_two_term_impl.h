...
static inline weight_t weight_get_final(weight_state_t new_state) {
    ...
    log_mini_debug("%u%u%d%d%d%d", 7239,new_state.initial_weight, new_state.a2_plus,new_state.a2_minus, new_state.a3_plus, new_state.a3_minus);
    /* "\told_weight:%u, a2+:%d, a2-:%d, a3+:%d, a3-:%d"*/


    log_mini_debug("%u%d%d%d%d%d", 7240,scaled_a2_plus, scaled_a2_minus, scaled_a3_plus,scaled_a3_minus, new_weight);
    /* "\tscaled a2+:%d, scaled a2-:%d, scaled a3+:%d, scaled a3-:%d, new_weight:%d"*/
